...
(function () {
  ...
  function cleanScreen(s) {
    return ['journey', 'library', 'station', 'detail', 'pathways', 'videos', 'readings', 'compare', 'reading', 'glossary', 'cards', 'assignments', 'career', 'review', 'activity', 'ecology'].indexOf(s) >= 0 ? s : 'journey';
  }
